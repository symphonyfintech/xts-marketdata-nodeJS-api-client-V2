...
module.exports = class MDRestAPI {
    ...
    async logOut() {
        ...
        try {
            ...
            let response = await request.processRequest("Delete", this.url + settings.restApi.logout, { 'authorization': this.token });
            return response;
    ...
    *  @param {string} reqObject.isTradeSymbol
    ...
    async searchInstrument(reqObject) {
        try {
            ...
            await this.checkLoggedIn();
            let response = await request.processRequest("GET", this.url + settings.restApi.searchInstruments + "?searchString=" + reqObject.searchString + "&source=" + reqObject.source, { 'authorization': this.token }, null);
            return response;
    ...
    async instrumentMaster(reqObject) {
        try {
            ...
            await this.checkLoggedIn();
            let response = await request.processRequest("POST", this.url + settings.restApi.instrumentMaster , { 'authorization': this.token }, reqObject);
            return response;
    ...
    async instrumentByISIN(reqObject) {
        try {
            ...
            await this.checkLoggedIn();
            let response = await request.processRequest("POST", this.url + settings.restApi.searchInstrumentsByISIN , { 'authorization': this.token }, reqObject);
            return response;
    ...
    async getOHLC(reqObject) {
        try {
            ...
            let response = await request.processRequest("GET", this.url + settings.restApi.ohlc  + "?exchangeSegment=" + reqObject.exchangeSegment  +
             "&exchangeInstrumentID=" + reqObject.exchangeInstrumentID +
             "&startTime=" + reqObject.startTime+
             "&endTime=" + reqObject.endTime+
             "&compressionValue=" + reqObject.compressionValue,{ 'authorization': this.token }, null);
            return response;
  ...
  /**
    ...
    async getSubscriptionlist(reqObject) {
        try {
            ...
            let response = await request.processRequest("GET", this.url + settings.restApi.subscription  + "?xtsMessageCode=" + reqObject.xtsMessageCode,{ 'authorization': this.token }, null);
            return response;
    ...
    async getIndexList(reqObject) {
        try {
            ...
            let response = await request.processRequest("GET", this.url + settings.restApi.indexlist  + "?exchangeSegment=" + reqObject.exchangeSegment,{ 'authorization': this.token }, null);
            return response;
